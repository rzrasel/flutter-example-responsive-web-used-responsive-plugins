...
import 'package:flutter_rz_responsive_design_implementation/src/component/widget/rz_icon_text_form_field.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: RzTheme.color.borderColor.gray, width: 1),
        ),
      ),
